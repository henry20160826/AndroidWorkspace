...
public class InternetHelper {
	...
	public String getPicData(String EID, String md5) throws IOException{
		Document document = Jsoup.connect(PIC_AND_GPS_PATH)
				.data("md5", md5)
				.data("EID", EID)
				.data("info_type", "0").get();
		return document.body().text();
	}
