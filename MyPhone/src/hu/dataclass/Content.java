...
public class Content {
	// 服务器ip
	public final static String SERVER_IP = "192.168.155.1";
	...
	public final static String SPLITE_NAME = ",";
	public final static String PATH = "//MyPhone//";

	// listview固定参数
	public final static String ITEM_IMAGE = "ItemImage";
	public final static String ITEM_TIITLE = "ItemTitle";
